...
#define TRADING_HOURS_IN_DAY 6.5
#define MINUTES_IN_HOUR 60

std::map<std::string, double> ANNUALIZER = {
...
std::map<std::string, double> FUTURE_EXCHANGE_FEES_BY_SYMBOL = {
        {"AD", 1.60},  // AUD
...
#define DEFAULT_ETA 0.049018143225019836

std::map<std::string, double> ROOT_SYMBOL_TO_ETA = {
        {"AD", DEFAULT_ETA},  // AUD
