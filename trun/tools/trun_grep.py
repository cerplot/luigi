...
def main():
    parser = argparse.ArgumentParser(
        "trun-grep is used to search for workflows using the trun scheduler's json api")
    parser.add_argument(
        "--scheduler-host", default="localhost", help="hostname of the trun scheduler")
    parser.add_argument(
        "--scheduler-port", default="8082", help="port of the trun scheduler")
    ...
    grep = TrunGrep(args.scheduler_host, args.scheduler_port)
