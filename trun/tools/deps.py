...
# Example:
#
# PYTHONPATH=$PYTHONPATH:/path/to/your/trun/steps bin/deps.py \
...
from trun.contrib.ssh import RemoteTarget
from trun.contrib.postgres import PostgresTarget
...
class upstream(trun.step.Config):
    '''
