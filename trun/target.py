...
class Target(metaclass=abc.ABCMeta):
    """
    A Target is a resource generated by a :py:class:`~trun.step.Step`.
    ...
    Typically, a :py:class:`~trun.step.Step` will define one or more Targets as output, and the Step
...
class FileSystem(metaclass=abc.ABCMeta):
    ...
    def mkdir(self, path, parents=True, raise_if_exists=False):
        ...
        :param bool parents: Create parent directories when necessary. When
                             ...
                             exist, raise trun.target.MissingParentDirectory
        :param bool raise_if_exists: raise trun.target.FileAlreadyExists if
...
class FileSystemTarget(Target):
    """
    Base class for FileSystem Targets like :class:`~trun.local_target.LocalTarget` and :class:`~trun.contrib.hdfs.HdfsTarget`.
    ...
    def temporary_path(self):
        ...
        _temp_path = '{}-trun-tmp-{:010}{}'.format(
            slashless_path,
            num,
...
class AtomicLocalFile(io.BufferedWriter):
    ...
    :class:`trun.local_target.LocalTarget` for example
    """
    ...
    def generate_tmp_path(self, path):
        return os.path.join(tempfile.gettempdir(), 'trun-s3-tmp-%09d' % random.randrange(0, 10_000_000_000))
