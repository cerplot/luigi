"""
``trun.date_interval`` provides convenient classes for date algebra.
Everything uses ISO 8601 notation, i.e. YYYY-MM-DD for dates, etc.
There is a corresponding :class:`trun.parameter.DateIntervalParameter` that you can use to parse date intervals.
...
class DateInterval:
    ...
    Example::
       ...
       x = trun.date_interval.Week(2013, 52)
       print x.prev()
