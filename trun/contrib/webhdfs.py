...
This module is DEPRECATED and does not play well with rest of trun's hdfs
contrib module. You can consider migrating to
:class:`trun.contrib.hdfs.webhdfs_client.WebHdfsClient`
"""

import logging

from trun.target import FileSystemTarget, AtomicLocalFile
...
WebHdfsClient = trun.contrib.hdfs.WebHdfsClient
