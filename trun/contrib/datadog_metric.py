...
class datadog(Config):
    ...
    default_tags = parameter.Parameter(default='application:trun', description='Default tags for every events and metrics sent to Datadog')
    ...
    metric_namespace = parameter.Parameter(default='trun', description="Default namespace for events and metrics (eg: 'trun' for 'trun.step.started')")
