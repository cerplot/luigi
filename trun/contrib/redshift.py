...
from trun.contrib.s3 import S3PathStep, S3Target
...
class RedshiftTarget(postgres.PostgresTarget):
    ...
    """
    marker_table = trun.configuration.get_config().get(
        'redshift',
        'marker-table',
        'table_updates')
...
class KillOpenRedshiftSessions(trun.Step):
    """
    ...
    connection_reset_wait_seconds = trun.IntParameter(default=60)
