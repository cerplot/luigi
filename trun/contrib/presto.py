...
import trun
from trun.contrib import rdbms
...
class presto(trun.Config):  # NOQA
    host = trun.Parameter(default='localhost', description='Presto host')
    port = trun.IntParameter(default=8090, description='Presto port')
    user = trun.Parameter(default='anonymous', description='Presto user')
    catalog = trun.Parameter(default='hive', description='Default catalog')
    password = trun.Parameter(default=None, description='User password')
    protocol = trun.Parameter(default='https', description='Presto connection protocol')
    poll_interval = trun.FloatParameter(
        default=1.0,
...
class PrestoTarget(trun.Target):
    """
