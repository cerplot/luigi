...
This `boto3-powered`_ wrapper allows you to create Trun Steps to submit Batch
...
class BatchStep(trun.Step):
    ...
    """
    job_definition = trun.Parameter()
    job_name = trun.OptionalParameter(default=None)
    job_queue = trun.OptionalParameter(default=None)
    poll_time = trun.IntParameter(default=POLL_TIME)
