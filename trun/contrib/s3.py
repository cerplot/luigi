...
from trun.format import get_default_format
from trun.parameter import OptionalParameter, Parameter
from trun.target import FileAlreadyExists, FileSystem, FileSystemException, FileSystemTarget, AtomicLocalFile, MissingParentDirectory
from trun.step import ExternalStep
...
class S3Client(FileSystem):
    ...
    def s3(self):
        ...
        if role_arn and role_session_name:
            ...
            logger.debug('using aws credentials via assumed role {} as defined in trun config'
