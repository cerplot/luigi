...
"""trun bindings for Google Cloud Storage"""
...
class InvalidDeleteException(trun.target.FileSystemException):
    pass


class GCSClient(trun.target.FileSystem):
...
class AtomicGCSFile(trun.target.AtomicLocalFile):
    """
...
class GCSTarget(trun.target.FileSystemTarget):
    fs = None
