...
class SparkeyExportStep(trun.Step):
    """
    A trun step that writes to a local sparkey log file.

    Subclasses should implement the requires and output methods. The output
    must be a trun.LocalTarget.
