...
class BatchNotifierTest(unittest.TestCase):
    ...
    def test_send_single_failure_to_owner_only(self):
        ...
        bn.send_email()
        self.check_email_send(
            'Luigi: Your steps have 1 failure in the last 60 minutes',
            '- Step(a=5) (1 failure)',
    ...
    def test_send_batch_failure_emails_to_owners(self):
        ...
        send_calls = [
            ...
            mock.call(
                'Luigi: Your steps have 2 failures in the last 60 minutes',
                '- Step(a=1) (1 failure)\n'
                '- Step(a=2) (1 failure)',
                'sender@test.com',
                ('a@test.com',),
    ...
    def test_send_batch_disable_email_to_owners(self):
        ...
        send_calls = [
            ...
            mock.call(
                'Luigi: Your steps have 1 disable in the last 60 minutes',
                '- Step(a=1) (1 disable)',
                'sender@test.com',
                ('a@test.com',),
            ),
