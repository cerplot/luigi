...
class Target(metaclass=abc.ABCMeta):
    """
    A Target is a resource generated by a :py:class:`~luigi.step.Step`.
    ...
    Typically, a :py:class:`~luigi.step.Step` will define one or more Targets as output, and the Step
